<div align="center">
  ...
  <h3 align="center">PrepbyAI: A job interview preparation platform powered by Vapi AI Voice agents</h3>
...
PrepbyAI is a modern, voice-driven interview preparation platform powered by AI voice agents (Vapi AI) and Google Gemini. Practice real-time mock interviews, get instant feedback, and track your progress—all in one sleek, responsive web app.
...
```bash
git clone https://github.com/vbhatt552/PrepbyAI
cd prepbyAI
```
